...
<head>
  <meta charset="utf-8" />
  <title>ค้นหารายการส่งเงินสมทบปกติ</title>
...
require '../connect/dbconnect.php';
            ...
            $sql = "SELECT * FROM add_contributions ";
            ...
            <form name="search_form" method="POST" action="DisplaySearch.php">
...
<table>
          ...
          <input type="submit" name="search" value="ค้นหารายการส่งเงินสมทบปกติ">
          ...
          <input type="submit" name="" value="ค้นหาทั้งหมด">
            ...
            <tr>
                ...
                <td><a href="../Edit/DisplayEditData.php?id=<?php echo $row[0]?>">Edit</a></td>
