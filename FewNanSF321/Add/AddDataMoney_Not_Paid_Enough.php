...
$sql = "INSERT INTO contributions (CorrespondenceNumber,Document,ReceiveDate,Province,District,DLA,ContributionType
...
$conn->close();
?>
<a href='../DisplayAddDataMoney_Not_Paid_Enough.html'>กลับหน้าหลัก</a>