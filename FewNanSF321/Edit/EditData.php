...
$sql = "UPDATE add_contributions SET ID ='$ID',CorrespondenceNumber = '$CorrespondenceNumber',Document='$Document',ReceiveDate='$ReceiveDate',Province='$Province',District='$District',DLA='$DLA',ContributionType='$ContributionType'
...
$conn->close();
?>
<a href='../Displaysearch.html'>กลับหน้าหลัก</a>
